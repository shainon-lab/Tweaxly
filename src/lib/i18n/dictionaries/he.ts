...
export const he: Dictionary = {
  ...
  "account.tab.workspaces": "סביבות עבודה",
  ...
  "settings.tab.businessSettings": "הגדרות העסק",
  "settings.tab.businessProfile":  "פרופיל העסק",
  "settings.tab.businessPlan":     "מסלול העסק",
  "settings.tab.import": "ייבוא נתונים",
  "settings.tab.sources": "מקורות ידניים",
  "settings.tab.integration": "אינטגרציה",
  "settings.tab.categories": "קטגוריות וספקים",
  "settings.tab.transactions": "עסקאות",
  "settings.tab.dataLog": "יומן נתונים ידני",
  // Data section tab labels
  "data.tab.sources":      "מקורות ידניים",
  "data.tab.import":       "ייבוא נתונים",
  "data.tab.integration":  "אינטגרציה",
  "data.tab.transactions": "עסקאות",
  "data.tab.categories":   "קטגוריות וספקים",
  "data.tab.dataLog":      "יומן נתונים ידני",
