// Yearly Summary — closed-year retrospective. Only shows years that have
// already ended (current calendar year is excluded — it's still in
// progress). Default selection is the most-recently-completed year.
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Top observations and the key numbers for the chosen year."
