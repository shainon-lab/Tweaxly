...
// Access, Workspaces). Opening the ? on any tab shows the same
// section-wide overview.
//
...
import { Building2, Sparkles, CreditCard, Users, Layers } from "lucide-react";
  ...
  return (
    <HowItWorks
      ...
      cards={[
        ...
        { icon: <Layers size={16} strokeWidth={1.7} />,     title: "Workspaces",       body: "All workspaces under your account. Switch between them, rename, or create a new one for a new business or client. Each is independent (plan, credits, team, data)." },
      ]}
      outro="Categories & Vendors looks like a Settings tab but actually belongs to the Data section - that's where it lives in the nav."
    />
  );
}
