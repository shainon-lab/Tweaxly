    ...
    <main id="main-content" className="flex-1">
      ...
      <nav aria-label="Breadcrumb" className="container-wide pt-8 pb-2">
        <ol className="flex items-center gap-2 text-xs text-slate-500 flex-wrap">
          ...
          <li className="text-slate-600">›</li>
          <li className="text-slate-300">Tweaxly vs {c.subject}</li>
        </ol>
      </nav>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {c.rows.map((row, i) => (
              ...
              >
                <td className="px-5 py-4 align-top text-slate-300 font-medium border-b border-line/40">
                  {row.dimension}
                </td>
                <td className="px-5 py-4 align-top text-slate-400 leading-relaxed border-b border-line/40">
                  {row.competitor}
                </td>
                <td className="px-5 py-4 align-top text-slate-200 leading-relaxed border-b border-line/40">
  ...
  return (
    <section className="container-wide pb-12 lg:pb-16">
      <div className="grid lg:grid-cols-2 gap-5 lg:gap-6 max-w-5xl">
        <div className="card">
          <div className="text-[10px] uppercase tracking-[0.22em] text-slate-400 font-semibold mb-3">
