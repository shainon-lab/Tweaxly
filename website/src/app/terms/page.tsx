  ...
  return (
    <main id="main-content" className="flex-1">
      ...
      <article className="container-wide py-12 max-w-3xl">
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-semibold tracking-tight text-[color:var(--color-ink-strong)]">Terms of Service</h1>
          <p className="mt-2 text-sm text-slate-600">Last Updated: {TERMS_LAST_UPDATED}</p>
        </div>
        <TermsContent />
      </article>
    </main>
