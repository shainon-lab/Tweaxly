...
export const ACCESSIBILITY_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      { kind: "text", body: "We strive to improve the accessibility and usability of our Services and aim to follow generally accepted accessibility standards and best practices, including relevant portions of the Web Content Accessibility Guidelines (WCAG), where reasonably applicable." },
      { kind: "text", body: "Our goal is to continuously improve the user experience for all visitors and users of the platform." },
    ],
  },
  {
    id: "features",
